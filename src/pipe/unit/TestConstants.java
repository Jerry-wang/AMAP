...
public final class TestConstants {
		  ...
		  public static final String timelessTrap = "src/pipe/test/resources/TimelessTrap.xml";
		  public static final String simpleColour = "src/pipe/test/resources/Simple Coloured Net.xml";
		  /**
