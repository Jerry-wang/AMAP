...
public class InvariantAnalysis
    ...
    * Nadeem 28/05/2005
    */
   private DataLayerInterface pnmlData;		// A reference to the Petri Net to be analysed
    ...
    * @version 1.2
    */
   private String analyse(DataLayerInterface pnmlData) {
      Date start_time = new Date(); // start timer for program execution
      // extract data from PN object
      int[][] array = pnmlData.getActiveTokenClass().getIncidenceMatrix(
    ...
    */
   public PNMatrix getPInvariants(DataLayerInterface sourceDataLayer) {
      int[][] array = sourceDataLayer.getActiveTokenClass()
    ...
    */
   public PNMatrix getTInvariants(DataLayerInterface sourceDataLayer) {
      int[][] array = sourceDataLayer.getActiveTokenClass().getIncidenceMatrix(
