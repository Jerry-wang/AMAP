...
public class Comparison
   ...
   ActionListener compareButtonClick = new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
         ...
         DataLayerInterface comparisonDataLayer = comparisonFilePanel.getDataLayer();
   ...
   public String comparePlaces(Place[] source, Place[] comparison,
      ...
      for (int i = 0; i < source.length; i++) {
         ...
         if (j != -1 && source[i] != null && comparison[j] != null) {
            ...
            if ((!compareID || source[i].getId().equals(comparison[j].getId())) &&
                    ...
                    (!compareMarking || source[i].getCurrentMarking().get(0).getCurrentMarking() 
                  		  == comparison[j].getCurrentMarking().get(0).getCurrentMarking()) &&
               ...
               if (compareMarking) {
                  s += "Marking";
                  if (source[i].getCurrentMarking().get(0).getCurrentMarking() 
                		  == comparison[j].getCurrentMarking().get(0).getCurrentMarking()) {
                     s += " (match)";
                  }
                  s += ": Source = \"" + source[i].getCurrentMarking().get(0).getCurrentMarking() +
                          "\"  Comparison  = \"" + 
                          comparison[j].getCurrentMarking().get(0).getCurrentMarking() +
                          "\"<br>";
               }
      ...
      for (int i = 0; i < source.length; i++) {
         if (source[i] != null) {
            ...
            if (compareMarking) {
               s += "<br>Marking = \"" + source[i].getCurrentMarking().get(0).getCurrentMarking() + "\"";
            }
            if (compareCapacity) {
      ...
      for (int i = 0; i < comparison.length; i++) {
         if (comparison[i] != null) {
            ...
            if (compareMarking) {
               s += "<br>Marking = \"" + comparison[i].getCurrentMarking().get(0).getCurrentMarking() + "\"";
            }
            if (compareCapacity) {
   ...
   private String compareTransitions(Transition[] source, Transition[] comparison,
      ...
      for (int i = 0; i < source.length; i++) {
         if (source[i] != null) {
            ...
            if (compareRate) {
               s += "<br>Rate/Weight= \"" + source[i].getRate() + "\""; //Nou-pere
            }
            if (comparePriority) {
      ...
      for (int i = 0; i < comparison.length; i++) {
         if (comparison[i] != null) {
            ...
            if (compareRate) {
               s += "<br>Rate/Weight = \"" + comparison[i].getRate() + "\"";//Nou-pere
            }
            if (comparePriority) {
   ...
   private String compareArcs(Arc[] source, Arc[] comparison, boolean compareName,
      ...
      for (int i = 0; i < source.length; i++) {
         if (source[i] != null) {
            ...
            if (compareWeighting) {
               s += "<br>Weighting= \"" + source[i].getWeight().get(0).getCurrentMarking() + "\"";
            }
            results.add(s);
         }
      }
      ...
      for (int i = 0; i < comparison.length; i++) {
         if (comparison[i] != null) {
            ...
            if (compareWeighting) {
               s += "<br>Weighting= \"" + comparison[i].getWeight().get(0).getCurrentMarking() + "\"";
            }
            results.add(s);
         }
      }
