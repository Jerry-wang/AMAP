...
//		  				+ " && " + arc.getSource().getId()+" > "+ (arc.getSimpleWeight()-1+1)
//		  				+ ") || ( tagged_location!="+getPlaceIndex(arc.getSource().getId())
//		  				+ " && " + arc.getSource().getId()+" > "+ (arc.getSimpleWeight()-1)
//		  				+ "))";
//		  		}
//		  		else condition += arc.getSource().getId()+" > "+ (arc.getSimpleWeight()-1);
//		  	}
//		  		
//		  	while (arcsTo.hasNext())
//		  	{
...
//		  	if (arcsTo.hasNext()){
//		  		final Arc arc = (Arc)arcsTo.next();
//		  		condition += arc.getSource().getId()+" > "+ (arc.getSimpleWeight()-1);
//		  	}
//		  		
//		  	while (arcsTo.hasNext())
//		  	{
