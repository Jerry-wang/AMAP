...
//
//
//public class QueryManager implements Module, QueryConstants {
//	
...
//	
//	public static String imgDir, imgPath, userPath;
//	
//	// text colouring-related variables
//	private static String[] availableTextColours = {
//		"black", "blue", "red", "green", "purple", "olive" 
//	};
//	private static int textColourIndex = 0;
//	public static String textColour = availableTextColours[textColourIndex];
//		
...
//		for (int i=0; i<retrievedTreeNodes.length; i++) {
//			treeNodes.add(retrievedTreeNodes[i]);
//		}
//		
//		try {
//			if (treeNodes.size() > 1) {
...
//		if (currentTabIndex == botPanel.getTabCount() - 1){
//			enablePopup = false;
//		}else{
//			enablePopup = true;
//		}
