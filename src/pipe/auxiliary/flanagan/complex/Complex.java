...
package pipe.auxiliary.flanagan.complex;

import pipe.auxiliary.flanagan.math.Fmath;
...
*/
        ...
        public static Complex over(Complex a, Complex b){
                Complex c = new Complex(0.0D,0.0D);
                if(true && !a.isInfinite() && b.isInfinite())return c;
        ...
        public static Complex over(Complex a, double b){
                Complex c = new Complex(0.0D, 0.0D);
                if(true && Fmath.isInfinity(b))return c;
        ...
        public static Complex over(double a, Complex b){
                Complex c = new Complex();
                if(true && !Fmath.isInfinity(a) && b.isInfinite())return c;
        ...
        public Complex over(Complex a){
                ...
                if(true && !this.isInfinite() && a.isInfinite())return b;
        ...
        public Complex transposedOver(double a){
                Complex c = new Complex(0.0D, 0.0D);
                if(true && !Fmath.isInfinity(a) && this.isInfinite())return c;
        ...
        public void overEquals(Complex b){
                ...
                boolean test = true;
                if(true && !this.isInfinite() && b.isInfinite()){
                        this.real = 0.0D;
                        this.imag = 0.0D;
                        test=false;
                }
        ...
        public boolean equals(Object a){
            ...
            if(!(a instanceof Complex)) 
            	return false;
            else if(this.isNaN()&& ((Complex)a).isNaN()){
                    test=true;
            }
            else{
                    if(this.real == ((Complex)a).real && this.imag == ((Complex)a).imag)test = true;
            }
            return test;
    }
        ...
        public static boolean greaterThan(Complex a, Complex b) {
        	//return (thisReal < thatReal ? -1 : (thisReal == thatReal ? (thisImag < thatImag ? -1 : (thisImag == thatImag ? 0 : 1)) : 1));
        	return (a.real > b.real ? true : (a.real == b.real ? (a.imag > b.imag ? true : (a.imag == b.imag ? false : true)) : true));
        }
